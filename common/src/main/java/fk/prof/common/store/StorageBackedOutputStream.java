...
public class StorageBackedOutputStream extends OutputStream {
    ...
    /**
     * OutputStream implementation which is backed by a storage. Every {@code partSize} chunk of the bytes
     * will be written to the storage. The target path of the chunk will be decided by the {@link FileNamingStrategy}.
     * @param storage
