...
public class GcBench {
    ...
    public static void main(String args[]) {
        runBenchmark(kStretchTreeDepth, kLongLivedTreeDepth, kArraySize, kMinTreeDepth, kMaxTreeDepth);
    }

    public static void runBenchmark(final int kStretchTreeDepth, final int kLongLivedTreeDepth, final int kArraySize, final int kMinTreeDepth, final int kMaxTreeDepth) {
        Node root;
        Node longLivedTree;
        Node tempTree;
        long tStart, tFinish;
